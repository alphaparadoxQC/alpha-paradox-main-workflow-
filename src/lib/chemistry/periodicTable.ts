...
export const ELEMENTS: ElementData[] = [
  ...
  { symbol: 'F', name: 'Fluorine', number: 9, mass: 18.9984031636, group: 17, period: 2, category: 'halogen', electronegativity: 3.98, valence: 1, covalentRadius: 0.57, color: '#90E050' },
  ...
  { symbol: 'Al', name: 'Aluminium', number: 13, mass: 26.98153857, group: 13, period: 3, category: 'post-transition', electronegativity: 1.61, valence: 3, covalentRadius: 1.21, color: '#BFA6A6' },
  ...
  { symbol: 'Ga', name: 'Gallium', number: 31, mass: 69.7231, group: 13, period: 4, category: 'post-transition', electronegativity: 1.81, valence: 3, covalentRadius: 1.5, color: '#AAAAAA' },
  ...
  { symbol: 'Br', name: 'Bromine', number: 35, mass: 79.904, group: 17, period: 4, category: 'halogen', electronegativity: 2.96, valence: 1, covalentRadius: 1.2, color: '#A62929' },
  ...
  { symbol: 'In', name: 'Indium', number: 49, mass: 114.8181, group: 13, period: 5, category: 'post-transition', electronegativity: 1.78, valence: 3, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Sn', name: 'Tin', number: 50, mass: 118.7107, group: 14, period: 5, category: 'post-transition', electronegativity: 1.96, valence: 4, covalentRadius: 1.5, color: '#AAAAAA' },
  ...
  { symbol: 'I', name: 'Iodine', number: 53, mass: 126.904473, group: 17, period: 5, category: 'halogen', electronegativity: 2.66, valence: 1, covalentRadius: 1.39, color: '#940094' },
  ...
  { symbol: 'Tl', name: 'Thallium', number: 81, mass: 204.38, group: 13, period: 6, category: 'post-transition', electronegativity: 1.62, valence: 3, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Pb', name: 'Lead', number: 82, mass: 207.21, group: 14, period: 6, category: 'post-transition', electronegativity: 1.87, valence: 4, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Bi', name: 'Bismuth', number: 83, mass: 208.980401, group: 15, period: 6, category: 'post-transition', electronegativity: 2.02, valence: 3, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Po', name: 'Polonium', number: 84, mass: 209, group: 16, period: 6, category: 'post-transition', electronegativity: 2, valence: 2, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'At', name: 'Astatine', number: 85, mass: 210, group: 17, period: 6, category: 'halogen', electronegativity: 2.2, valence: 1, covalentRadius: 1.5, color: '#AAAAAA' },
  ...
  { symbol: 'Nh', name: 'Nihonium', number: 113, mass: 286, group: 13, period: 7, category: 'post-transition', electronegativity: null, valence: 3, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Fl', name: 'Flerovium', number: 114, mass: 289, group: 14, period: 7, category: 'post-transition', electronegativity: null, valence: 4, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Mc', name: 'Moscovium', number: 115, mass: 289, group: 15, period: 7, category: 'post-transition', electronegativity: null, valence: 3, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Lv', name: 'Livermorium', number: 116, mass: 293, group: 16, period: 7, category: 'post-transition', electronegativity: null, valence: 2, covalentRadius: 1.5, color: '#AAAAAA' },
  { symbol: 'Ts', name: 'Tennessine', number: 117, mass: 294, group: 17, period: 7, category: 'halogen', electronegativity: null, valence: 1, covalentRadius: 1.5, color: '#AAAAAA' },
